...
singularity run --cleanenv -B /projects/b1108:/projects/b1108 /projects/b1108/software/singularity_images/fmriprep-20.2.3.simg /projects/b1108/data/BrainMAPD /projects/b1108/studies/brainmapd/data/processed/neuroimaging/mid participant --participant-label sub-21305 --fs-license-file /projects/b1108/software/freesurfer_license/license.txt --fs-no-reconall -w /projects/b1108/studies/brainmapd/data/processed/neuroimaging/mid/work --output-spaces MNI152NLin6Asym --skull-strip-template OASIS30ANTs --bids-filter-file /projects/b1108/studies/brainmapd/scripts/process/mid_fmriprep/config/ses-4_config.json --skip_bids_validation
